...
var precacheUrls = [];
  ...
  precacheUrls.push('/posts/1303/');

  precacheUrls.push('/posts/2414/');

  precacheUrls.push('/posts/39188/');

  precacheUrls.push('/posts/49118/');

  precacheUrls.push('/posts/39162/');

  precacheUrls.push('/posts/50340/');

  precacheUrls.push('/posts/28865/');

  precacheUrls.push('/posts/19620/');

  precacheUrls.push('/posts/1213/');

  precacheUrls.push('/posts/50691/');

  precacheUrls.push('/posts/43202/');

  precacheUrls.push('/posts/42171/');

  precacheUrls.push('/posts/13505/');

  precacheUrls.push('/posts/29158/');

  precacheUrls.push('/posts/62545/');

  precacheUrls.push('/posts/43023/');

  precacheUrls.push('/posts/7274/');

  precacheUrls.push('/posts/8207/');

  precacheUrls.push('/posts/26646/');

  precacheUrls.push('/posts/43688/');

  precacheUrls.push('/posts/50281/');

  precacheUrls.push('/posts/51216/');

  precacheUrls.push('/posts/22634/');
